...
class MapElitesRepertoire(flax.struct.PyTreeNode):
    ...
    def sample_full(
    ...
    ) -> Tuple[Genotype, Descriptor, Fitness, RNGKey]:
        ...
        Returns:
            ...
            fitnesses: the corresponding fitnesses
            random_key: an updated jax PRNG random key
        """
        ...
        fitnesses = jax.random.choice(subkey, self.fitnesses, shape=(num_samples,), p=p)

        return samples, descriptors, fitnesses, random_key
