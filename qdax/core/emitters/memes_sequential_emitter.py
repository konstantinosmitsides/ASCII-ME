...
from qdax.core.emitters.es_base_emitter import ESEmitter, ESEmitterState, added_repertoire
...
class MEMESSequentialEmitter(ESEmitter):
    ...
    def _sample_parents(
        ...
        added: jnp.ndarray,
        batch_size: int,
    ) -> Tuple[MEMESSequentialEmitterState, Genotype, optax.OptState, RNGKey]:
        """Sample new parents."""
