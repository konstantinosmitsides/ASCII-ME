...
class MAPElites:
    ...
    def __init__(
        ...
        self._emitter_1 = emitter_1
        self._emitter_2 = emitter_2
    ...
    def init(
        ...
        # ONLY MCPG NEEDS INIT
        
        emitter_state_1, random_key = self._emitter_1.init(
            random_key=random_key,
            repertoire=repertoire,
            genotypes=genotypes,
            fitnesses=fitnesses,
        ...
        emitter_state_1 = self._emitter_1.state_update(
            emitter_state=emitter_state_1,
            repertoire=repertoire,
            genotypes=genotypes,
            fitnesses=fitnesses,
            descriptors=descriptors,
        ...
        emitter_state_2 = self._emitter_2.state_update(
            emitter_state=emitter_state_2,
            repertoire=repertoire,
            genotypes=genotypes,
            fitnesses=fitnesses,
            descriptors=descriptors,
        ...
        return repertoire, emitter_state_1, emitter_state_2, random_key
    ...
    def update_1(
        ...
        emitter_state = self._emitter_1.state_update(
    ...
    def update_2(
        ...
        # WE WILL ADD ANOTHER FUNCTION FOR THE OTHER EMITTER AND THE CONDITION WILL BE IN THE FOR LOOP IN THE MAIN
        genotypes, _, random_key = self._emitter_2.emit(
            repertoire, emitter_state, random_key
        )
        ...
        # update emitter state after scoring is made
        emitter_state = self._emitter_2.state_update(
            emitter_state=emitter_state,
            repertoire=repertoire,
            genotypes=genotypes,
            fitnesses=fitnesses,
