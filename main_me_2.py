...
from qdax.core.emitters.me_2_emitter import ME2CONFIG, ME2Emitter
...
@hydra.main(version_base="1.2", config_path="configs/", config_name="me_2")
def main(config: Config) -> None:
    ...
    variation_fn_2 = functools.partial(
        isoline_variation, iso_sigma=config.algo.iso_sigma_2, line_sigma=config.algo.line_sigma_2
    ...
    me_emitter = ME2Emitter(
        config=me_config,
        variation_fn=variation_fn,
        variation_fn_2=variation_fn_2
    )
