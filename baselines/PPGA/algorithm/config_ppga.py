...
class PPGAConfig:
    ...
    @classmethod
    def get_grid_size_num_dims(cls, brax_env_name):
        if brax_env_name == "ant_uni":
            grid_size = 6
            num_dims = 4
        elif brax_env_name == "ant_omni":
            grid_size = 32
            num_dims = 2
        elif brax_env_name == "walker2d_uni":
            grid_size = 32
            num_dims = 2
        elif brax_env_name == "anttrap_omni":
            grid_size = 32
            num_dims = 2

        elif brax_env_name == "hopper_uni":
            grid_size = 1024
            num_dims = 1
        else:
    ...
    def override_config(cls, brax_env_name):
        ...
        elif brax_env_name == "ant_uni" or brax_env_name == "ant_omni" or brax_env_name == "anttrap_omni":
            override_config = {
                "anneal_lr": True,
                "clip_obs_rew": False,
        ...
        elif brax_env_name == "walker2d_uni" or brax_env_name == "hopper_uni":
            override_config = {
                "clip_obs_rew": False,
                "learning_rate": 0.001,
                "sigma0": 1,
    ...
    def create(cls, hydra_config,) -> PPGAConfig:
        ...
        brax_env_name = hydra_config.env.name

        grid_size, num_dims = cls.get_grid_size_num_dims(brax_env_name)

        env_name = f"{brax_env_name}"
