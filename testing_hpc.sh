python main.py algo=ppoish_me seed=$RANDOM env=ant_uni env.episode_length=1000 num_iterations=21 algo.NORMALIZE_ENV=False algo.init_lecun=False algo.sample_trajectory=True algo.buffer_sample_batch_size=2 algo.PG_emitter=False policy_hidden_layer_sizes=[64,64]   #algo.grad_steps=16
